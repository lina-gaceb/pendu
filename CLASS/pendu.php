...
class Pendu // création class nomé pendu
{
    //déclaration d'une propriété
    public $played;


    //déclaratiion des méthodes
    ...
    public function homepage()
    {
        ...
        {
            echo "<p class=\"box-titre\"> Bienvenue sur le jeu du Pendu !</p>
            <img class=\"box-img\" src='IMAGE/pendue.png'><br>
            <a href='../index.php?etat=jouer'><button class=\"box-button\">Continuer</button></a> <br>
            <a href='../pendu/TRAITEMENT/newparty.php'><button  class=\"box-button\">Nouvelle partie</button></a>";  
        }
        else
        {
            echo "<p class=\"box-titre\"> Bienvenue sur le jeu du Pendu !</p>
    ...
    public function lostparty($mot)
    {
        ...
        <a href='../pendu/TRAITEMENT/restart.php'><button class=\"box-button\" >Recommencer</button></a><br>"; 
        exit();
    }
    ...
    public function choixMot($fichier)
    {
        ...
        {
            $_SESSION['mot'] = rtrim($fichier[array_rand($fichier)]); // rtrim efface espace
        }
    }
    ...
    public function mauvaisesLettres($mot)
    {
        ...
        $this->played = $played;        
            ...
            {
                if(!in_array($played[$k], str_split($mot)))// ( in_array): si app au tableu, converti chaine caractere en tableu
                {
                    $_SESSION['false']++;
                }
            }
